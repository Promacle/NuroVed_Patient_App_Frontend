...
class _FamilyProfilesScreenState extends State<FamilyProfilesScreen> {
  ...
  // Inside your _FamilyProfilesScreenState build method:
  @override
  Widget build(BuildContext context) {
    // Use ListenableBuilder targeting the ProfileController
  ...
  // Add this helper method to handle the confirmation
  void _confirmDeletion(BuildContext context, int index, String name) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          TextButton(
            onPressed: () {
              _controller.removeFamilyMember(index);
