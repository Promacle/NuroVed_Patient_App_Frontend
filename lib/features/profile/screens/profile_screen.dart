    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          LogoutButton(
            onLogout: () {
              // 1. Optional: Add your logout logic (clearing session, etc.)
              _controller.logout();

              // 2. Navigate to login and clear the entire stack
              // This ensures the user cannot go "back" to the profile
