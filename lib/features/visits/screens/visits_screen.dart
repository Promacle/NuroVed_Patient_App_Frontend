...
class _VisitsScreenState extends State<VisitsScreen> {
  ...
  Widget _buildHeader() {
    final profileController = ProfileController(); // Get the singleton

    return ListenableBuilder(
      listenable: profileController,
      builder: (context, _) {
        final activeName = profileController.activeProfileName;
        // Find the currently selected profile's data (to get its photo)
              ...
              Row(
                ...
                children: [
                  ...
                  ProfileSelector(
                    ...
                    imageFile: activeMember['imageFile'], // PASS THE PHOTO HERE
                    ...
                    onSelected: (name) {
                      setState(() {
                        ...
                        _controller
                            .loadVisits(); // Refresh visits for this person
                      });
                    },
                  ),
                ],
